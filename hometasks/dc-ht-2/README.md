...
Таким образом, остаётся назначить IPv6-адреса только интерфейсам loopback 0, а заодно и определить router-id для каждого коммутатора. Пусть адреса, назначаемые интерфейсам loopback 0, принадлежат сети fd12:dc:1:0::/64.
